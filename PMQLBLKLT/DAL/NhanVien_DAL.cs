...
namespace DAL
{
    public class NhanVien_DAL
    {
        ...
        {
            string ngaySinhString = ex.NgaySinh.HasValue ? ex.NgaySinh.Value.ToString("yyyy-MM-dd") : "NULL";
            //string query = @"UPDATE NhanVien SET MaCV=N'" + ex.MaCV + "',TenNV=N'" + ex.TenNV + "',GioiTinh=N'" + ex.GioiTinh + "',Email=N'" + ex.Email + "',NgaySinh='" + ngaySinhString + "',DienThoai=N'" + ex.DienThoai + "',CMND=N'" + ex.CMND + "',DiaChi=N'" + ex.DiaChi + "',HinhAnh=N'" + ex.HinhAnh + "',UserName=N'" + ex.UserName + "',PassWord=N'" + ex.PassWord + "',TrangThai=N'" + ex.TrangThai + "' Where MaNV='" + ex.MaNV + "' ";
        KetNoi.ExecuteReader(@"UPDATE NhanVien SET MaCV=N'" + ex.MaCV + "',TenNV=N'" + ex.TenNV + "',GioiTinh=N'" + ex.GioiTinh + "',Email=N'" + ex.Email + "',NgaySinh='" + ngaySinhString + "',DienThoai=N'" + ex.DienThoai + "',CMND=N'" + ex.CMND + "',DiaChi=N'" + ex.DiaChi + "',HinhAnh=N'" + ex.HinhAnh + "',UserName=N'" + ex.UserName + "',PassWord=N'" + ex.PassWord + "',TrangThai=N'" + ex.TrangThai + "' Where MaNV='" + ex.MaNV + "' ");
        }
        ...
        public void UpdateThongTin(NhanVien ex)
        {
            string ngaySinhSql = ex.NgaySinh?.ToString("yyyy-MM-dd") ?? "NULL";

            KetNoi.ExecuteReader($@" UPDATE NhanVien SET TenNV = N'{ex.TenNV}', GioiTinh = N'{ex.GioiTinh}', Email = N'{ex.Email}', NgaySinh = {(ex.NgaySinh.HasValue ? $"'{ngaySinhSql}'" : "NULL")},DienThoai = N'{ex.DienThoai}', CMND = N'{ex.CMND}', DiaChi = N'{ex.DiaChi}', UserName = N'{ex.UserName}', PassWord = N'{ex.PassWord}' WHERE MaNV = '{ex.MaNV}'");
        }
    }
}
