    ...
    public partial class Frm_SanPham : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            if (flag == 1)
            {
                ...
                {
                    errorMes.BlinkRate = 100;
                    errorMes.SetError(cboNCC, "Chưa chọn nhà cung cấp");
                    return;
                }
                //làm thêm
                if (cboNSX.Text == "")
                {
                    errorMes.BlinkRate = 100;
                    errorMes.SetError(cboNCC, "Chưa chọn nhà sản xuất");
                    return;
                }
                ...
                else
                {
                    ...
                    lk.MaNCC = cboNCC.SelectedValue.ToString();
                    // làm thêm                    
                    lk.MaNSX = cboNSX.SelectedValue.ToString() ;
            ...
            if (flag == 2)
            {
                ...
                //làm thêm
                if (cboNSX.SelectedValue.ToString() == "")
                {
                    errorMes.BlinkRate = 100;
                    errorMes.SetError(cboNCC, "Chưa chọn nhà sản xuất");
                    return;
        ...
        public void HienThiLK_TXT(int vitri, DataTable d)
        {
            try
            {
                ...
                cboNCC.Text = d.Rows[vitri]["TenNCC"].ToString();
                ...
                //làm thêm
                cboNSX.Text = d.Rows[vitri]["TenNSX"].ToString();
        ...
        private void dataGridViewLK_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                cboNCC.Text = row.Cells["MaNCC"].Value.ToString();
                //làm them
                cboNSX.Text = row.Cells["MaNSX"].Value.ToString();
